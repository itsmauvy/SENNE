const PRODUCTS = [
  {
    ...
    notes: { top: "화이트 머스크", mid: "로즈, 재스민", base: "샌달우드" },
    details: [
  ...
  },
  {
    ...
    notes: { top: "그린 베르가못", mid: "카멜리아 플로럴", base: "클린 우디" },
    details: [
  ...
  },
  {
    ...
    notes: { top: "화이트 프리지아", mid: "재스민, 로즈", base: "앰버, 머스크" },
    details: [
  ...
  },
  {
    ...
    notes: { top: "그린 시트러스", mid: "화이트 머스크", base: "샌달우드" },
    details: [
  ...
  },
  {
    ...
    notes: { top: "베르가못", mid: "화이트 머스크", base: "카시미어 우드" },
    details: [
      { label: "용량", value: "200ml / 6.7 fl.oz" },
  ...
  },
  {
    ...
    notes: { top: "그린 티", mid: "재스민", base: "샌달우드, 앰버" },
    details: [
  ...
  },
  {
    ...
    notes: { top: "그레이프프루트", mid: "화이트 머스크", base: "시더우드" },
    details: [
  ...
  },
  {
    ...
    notes: { top: "라벤더", mid: "린넨 머스크", base: "화이트 우드" },
    details: [
